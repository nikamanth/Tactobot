...
#ifndef CTASKOPORI_HPP_
#define CTASKOPORI_HPP_
...
namespace scl_app
{
   ...
   */
class CTaskOpOri : public scl::CTaskBase
{
public:
  /********************************
   * CTaskBase API
  ...
  virtual bool getGoalOri(Eigen::Quaterniond & arg_goal) const
  ...
  { arg_goal = data_->dlam_goal_; return true; }
  ...
  { arg_goal = data_->ddlam_goal_; return true; }

  /** Gets the current position. Returns false if not supported by task. */
  virtual bool getOri(Eigen::Quaterniond & arg_pos) const
