...
#ifndef CTASKOPPOSITION_HPP_
#define CTASKOPPOSITION_HPP_
...
namespace scl_app
{
   ...
   */
class CTaskOpPosition : public scl::CTaskBase
{
public:
  /********************************
   * CTaskBase API
  ...
  virtual bool setGoalPosition(const Eigen::VectorXd & arg_goal);
  ...
  virtual bool getGoalPosition(Eigen::VectorXd & arg_goal) const
  ...
  virtual bool getPosition(Eigen::VectorXd & arg_pos) const
  ...
  scl::sBool achievedGoalPosition();
